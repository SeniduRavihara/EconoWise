...
import { ClientTable, UserDataType } from "@/types";
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() => {
                setOpenSendMessagePopup(true); // Update the state
                setSelectedUser(
                  usersData?.find(
                    (user) => (user as UserDataType).uid === student.uid
                  ) || null
                );
                console.log("Details SEND MESSAGE:", student);
              }}
            >
              Send Message
            </DropdownMenuItem>
